namespace lesson14_继承_继承中的构造函数
{
    ...
    #region 3.父类的无参构造函数重要
    //子类实例化时，默认自动调用的是父类的无参构造，所以如果父类无参构造函数被顶掉，会报错
    class Father
    {
        //public Father()
        //{
    ...
    class Son : Father
    {
        #region 4.通过base调用指定父类构造
        public Son(int i) : base(i)
        {
            Console.WriteLine("Son的1个构造函数");
        }
        public Son(int i, string str) : this(i)
        {
            Console.WriteLine("Son的2个构造函数");
        }
        #endregion
    }
    #endregion
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //继承中的构造函数
            //特点
            //执行顺序:先执行父类的构造函数,再执行子类的,依次一代一代向下执行
            //父类中的无参构造函数,很重要
